...
export function MathGenerator({ templateName, onPlay }: MathGeneratorProps) {
  ...
  const operations = [
    { id: 'addition', name: 'Addition', icon: Plus, symbol: '+', color: 'from-blue-500 to-cyan-500' },
    { id: 'subtraction', name: 'Subtraction', icon: Minus, symbol: '-', color: 'from-purple-500 to-pink-500' },
    { id: 'multiplication', name: 'Multiplication', icon: X, symbol: '×', color: 'from-orange-500 to-red-500' },
    { id: 'division', name: 'Division', icon: Divide, symbol: '÷', color: 'from-green-500 to-teal-500' },
  ];
    ...
    for (let i = 0; i < questionCount; i++) {
      ...
      switch (operation) {
        ...
        case 'division':
          ...
          answer = num2;
          num1 = num2 * Math.floor(Math.random() * (maxNumber - minNumber + 1) + minNumber);
          display = `${num1} ÷ ${num2}`;
          break;
      }
              ...
              {operations.map((op) => {
                ...
                return (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                  >
                    <div className={`w-12 h-12 mx-auto mb-2 rounded-full bg-gradient-to-br ${op.color} flex items-center justify-center`}>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border-2 border-purple-100">
            ...
            <div className="flex items-center gap-2 text-gray-700">
              ...
              <span className="px-4 py-2 bg-white rounded-lg shadow-sm">
                {minNumber} {operations.find(o => o.id === operation)?.symbol} {maxNumber}
              </span>
            </div>
          </div>
