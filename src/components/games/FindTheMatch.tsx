...
export function FindTheMatch({ questions, onComplete }: FindTheMatchProps) {
      ...
      if (flippedCards[0].value === flippedCards[1].value) {
        ...
        setTimeout(() => {
          ...
          const allMatched = cards.every(c =>
            c.id === flippedCards[0].id || c.id === flippedCards[1].id || c.isMatched
          );
          if (allMatched) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-500 via-rose-500 to-red-500 p-8">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="text-center mb-8">
          <h2 className="text-white mb-2">Find the Match</h2>
          <p className="text-white/90">Flip cards to find matching pairs</p>
