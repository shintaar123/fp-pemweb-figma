...
export function GameshowQuiz({ questions, onComplete }: GameshowQuizProps) {
        ...
        <div className="grid grid-cols-2 gap-6">
          {question.options?.map((option, index) => {
            ...
            return (
              ...
              >
                {/* Letter Badge */}
                <div className={`absolute top-4 left-4 w-12 h-12 rounded-full flex items-center justify-center text-xl ${
                  showResult && isCorrect
